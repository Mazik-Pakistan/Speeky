...
# E-03: sensitive-data patterns. Deliberately conservative — over-redacting is far safer
# than leaking PII into an LLM prompt.
SENSITIVE_PATTERNS = {
...
def _redact_sensitive_data(text: str):
    """E-03: strip phone/CNIC/SSN/email + address-labeled lines before anything reaches
    an LLM. Returns (redacted_text, list_of_types_redacted)."""
    redacted_types = []
    result = text
