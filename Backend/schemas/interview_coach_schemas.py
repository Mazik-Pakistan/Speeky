...
class InterviewMode(str, Enum):
    STANDARD = "standard"          # US-45 base simulation
    PANEL = "panel"                # US-40
    CASE_STUDY = "case_study"      # US-42
    MULTI_ROUND = "multi_round"    # US-43
...
class Panelist(BaseModel):
    """A single interviewer inside a panel/group interview (US-40)."""
    name: str
